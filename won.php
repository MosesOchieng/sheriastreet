		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 text-center animate-box">
					<div class="services">
						<div class="desc">
							<h3><a href="#">Impact Hub Justice Center.</a></h3>
							<p>Kibera and Langate consituency</p>
				...
				<div class="col-md-4 text-center animate-box">
					<div class="services">
						<div class="desc">
							<h3><a href="#">Mathare Social Justice Center</a></h3>
							<p>Mathare COnsituency </p>
				...
				<div class="col-md-4 text-center animate-box">
					<div class="services">
						<div class="desc">
							<h3><a href="#">Kariobangi North Social Justice Center </a></h3>
							<p>Working with communities in GBV.</p>
							<strong>Nairobi Area</strong>
						</div>
					</div>
				</div>
				<div class="col-md-4 text-center animate-box">
					<div class="services">
						<div class="desc">
							<h3><a href="#">Nakuru Social Justice Center</a></h3>
							<p>Working with social justice centers in Nakuru to fight GBV.</p>
							<strong>Nakuru County</strong>
						</div>
					</div>
				</div>
		...
		<div class="container">
			<div class="row row-pb-md">
				<div class="col-md-3 colorlib-widget">
					<h4>Sheria Street</h4>
					<p>Tech. Organization that provides solutions to GBV.</p>
				</div>
