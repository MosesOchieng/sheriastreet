				...
				<div class="row">
					...
					<div class="col-md-10 text-right menu-1">
						<ul>
							...
							<li class="btn-cta"><a href="#"><span>Report Cases.</span></a></li>
						</ul>
					</div>
				</div>
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner desc">
		   					...
		   					<p class="colorlib-lead">Tech. Organization that provides solutions to Gender Based Violence victims by connecting them to social justice centers <a href="#" target="_blank">Sheria Street.</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
